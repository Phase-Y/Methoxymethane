...
public class DMEMetaItemCircuit extends DMEStandardMetaItem {
    ...
    public void registerSubItems() {
        ...
        NEURON_CIRCUIT_ULV = this.addCircuit(90, "neuron", 0);
        NEURON_CIRCUIT_LV = this.addCircuit(91, "neuron", 1);
        NEURON_CIRCUIT_MV = this.addCircuit(92, "neuron", 2);
        NEURON_CIRCUIT_HV = this.addCircuit(93, "neuron", 3);
        NEURON_CIRCUIT_EV = this.addCircuit(94, "neuron", 4);
        NEURON_CIRCUIT_IV = this.addCircuit(95, "neuron", 5);
        NEURON_CIRCUIT_LuV = this.addCircuit(96, "neuron", 6);
        NEURON_CIRCUIT_ZPM = this.addCircuit(97, "neuron", 7);
        NEURON_CIRCUIT_UV = this.addCircuit(98, "neuron", 8);
        NEURON_CIRCUIT_UHV = this.addCircuit(99, "neuron", 9);
        NEURON_CIRCUIT_UEV = this.addCircuit(100, "neuron", 10);
        NEURON_CIRCUIT_UIV = this.addCircuit(101, "neuron", 11);
        NEURON_CIRCUIT_UXV = this.addCircuit(102, "neuron", 12);
        NEURON_CIRCUIT_OpV = this.addCircuit(103, "neuron", 13);
        NEURON_CIRCUIT_MAX = this.addCircuit(104, "neuron", 14);
